            ...
            <div className="rounded-xl border bg-white p-5 shadow-sm">
              ...
              <div className="mt-4 space-y-2 text-sm">
                ...
                <div>
                  ...
                  {selectedBuyer.pricePerLead
                    ? `$${Number(selectedBuyer.pricePerLead).toFixed(2)}`
                    : "—"}
                </div>
                <div>
                  <span className="font-medium">Min Bid:</span>{" "}
                  {selectedBuyer.minBid
                    ? `$${Number(selectedBuyer.minBid).toFixed(2)}`
                    : "—"}
                </div>
                <div>
                  <span className="font-medium">Timeout:</span>{" "}
                  {selectedBuyer.timeoutMs ?? "—"}
                </div>
                <div>
                  <span className="font-medium">Status:</span> {selectedBuyer.status}
                </div>
              </div>
            </div>
